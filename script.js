...
function shuffleCardImageClasses() {
  ...
  //console.log(result)
   ...
   const shuffledCardClasses = _.shuffle(cardClasses);
...
function doCardsMatch(cardObject1, cardObject2) {
  ...
  /*if (cardObject1 === cardObject1) {
    return true;
  } else if (cardObject2 === cardObject2) {
    return true;
  } else {
    return false;
  }*/
  ...
  //doCardsMatch(cardObject1, cardObject2);
    ...
    cardObject1 == cardObject1;
    cardObject1 == cardObject2;
    cardObject2 == cardObject2;
...
//FIRST TIME YOU FLIP A CARD OVER
// counters = {
//    flipCounter: 1
// }

//  NEXT TIME YOU FLIEP A CARD OVER
// counters = {
//    flipCounter: 2
// }

//  FIRST TIME YOU FIND A MATCH
...
function onCardFlipped(newlyFlippedCard) {
  ...
  incrementCounter("flipCounter", document.getElementById("flip-count"));
  //Keep in mind it says we are using the function - and a function typically has parameters: so what are ours?
  //and then those parameters help increment the flip counter UI
  //UI stands for User Interface - what is the front end we learned last course that the user interacts with? How do we tell the function what part of that UI to pull from? Hint: onclick we used with Magic 8 Ball
  ...
  //incrememnt the match counter
    //incrementCounter("matchCounter", document.getElementById("match-count"));
  
	  if(newlyFlippedCard.shuffledImageClass == lastCardFlipped.shuffledImageClass) {
      incrementCounter("matchCounter", document.getElementById("match-count"));
